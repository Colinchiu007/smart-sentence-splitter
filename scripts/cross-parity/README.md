...
# 2) TS 侧（argv: corpus.json 引擎模块路径 输出路径；引擎模块指向 Multi-Publish story2video-engine）
npm exec --yes --package=tsx -- tsx D:/Data/projects/smart-sentence-splitter/scripts/cross-parity/run_typescript.ts D:/Data/projects/smart-sentence-splitter/scripts/cross-parity/corpus.json D:/Data/projects/Multi-Publish/packages/story2video-engine/src/text-segmentation.ts /tmp/out_ts.json
